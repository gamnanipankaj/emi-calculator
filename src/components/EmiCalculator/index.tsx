    ...
    return (
        <div id="emi-calculator" className="mt-8">
            <div id="emi-inputs" className="flex flex-col justify-center items-center">
                <MortgageInput label="Amount" value={amount} setValue={setAmount} />
                <MortgageInput label="Interest" value={interest} setValue={setInterest} />
                <MortgageInput label="Months" value={months} setValue={setMonths} />
                <div className="mt-6">
